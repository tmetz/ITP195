"""
Compare Declaration of Independence and Gettysburg Address using set operations
"""
...
def main():
    ...
    declaration_independence_set = set()
    ...
    for line in declaration_independence_file:
        process_line(line, declaration_independence_set)
    pretty_print(gettysburg_address_set, declaration_independence_set)
